...
devices = [
    Device(id=devid, train_ds=get_device_data(get_device_distribution(devid), train_size//args.num_devices), test_ds=test_ds, device=compute_device, args=args, x_pos=0, y_pos=0, radio_range=10) for
